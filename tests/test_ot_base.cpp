...
static void test_np99sender(int ot_num, vector<array<oc::block, 2>>& pair_keys,
                            config_param& param) {
  connection c(0, "127.0.0.1", 9001);
  //   config_param param, param2;
  //   SPDLOG_LOGGER_INFO(spdlog::default_logger(),
  //   "ecc_lib_name:{},curve_name:{}",
...
static void test_np99receiver(int ot_num, vector<oc::block>& single_keys,
                              oc::BitVector& choices, config_param& param) {
...
int main(int argc, char** argv) {
  ...
  choices.randomize(rng);
  //
  thread th1(test_np99sender, ot_num, ref(pair_keys), ref(param));
  ...
  //   test_cereal_block();
  cout << default_config_param.curve_name << endl;
  cout << default_config_param.ecc_lib_name << endl;
  cout << default_config_param.hasher_name << endl;
  cout << default_config_param.ot_n_1_name << endl;
  cout << default_config_param.ot_name << endl;
  cout << default_config_param.ote_name << endl;
  return 0;
}